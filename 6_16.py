...
#
# A washing machine allpows you to wash a jacket, which takes
...
if program == 'j':
    total_washing_machine += 40
elif program == 'u':
    total_washing_machine += 70
elif program == 's':
    total_washing_machine += 20

if extra_rinse == 'y':
    total_washing_machine += 15

if extra_spin == 'y':
    total_washing_machine += 9


print(f'Total washing time: {total_washing_machine} minutes')
